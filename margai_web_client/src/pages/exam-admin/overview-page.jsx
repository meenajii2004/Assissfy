...
function OverviewPage() {
  const { t } = useTranslation("exam-admin-overview-page");

  return (
    <>
      <Sidebar />
      <header className="ml-[16.975rem] flex items-center justify-between bg-[#F3F4FF] px-10 py-6 pb-0">
        <h1 className="text-4xl font-bold text-[#303972]">{t("title")}</h1>
      ...
      <main className="ml-[16.975rem] bg-[#F3F4FF] px-10 py-6 grid grid-cols-2 gap-10">
        <div>
